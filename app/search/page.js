...
return ( <div ref={containerRef} className="flex flex-col gap-1.5 w-full"> <label className="text-[11px] font-bold text-[#9e988f] uppercase tracking-wider">
{label} </label>
...
return ( <div className="relative z-10 max-w-[1440px] w-full mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-16 flex flex-col md:flex-row gap-6 md:gap-8 items-start"> <aside className="w-full md:w-[240px] shrink-0 bg-[#0e120e]/90 backdrop-blur-xl border border-white/[0.08] rounded-lg p-4 flex flex-col gap-4 md:sticky md:top-20"> <div className="flex items-center gap-2 text-[#F4B942] font-bold text-xs uppercase tracking-wider pb-2 border-b border-white/[0.08]"> <SlidersHorizontal size={14} /> <span>Filters</span> </div>
