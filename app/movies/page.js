...
title: 'Films',
description: 'Explore popular and timeless films on ILOVEBIRYANI.',
};
...
return ( 
<div className="relative min-h-screen bg-[#070907] text-[#f3ede2] flex flex-col overflow-hidden"> <div className="fixed inset-0 z-0 pointer-events-none"> <Image
       src="/biryani.jpg"
       alt="Biryani bg "
       fill
       priority
    ...
    <main className="flex-1 max-w-[1440px] w-full mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-16">
      <div className="mb-6 sm:mb-8 border-b border-white/[0.08] pb-4">
        ...
        <p className="text-xs text-[#9e988f]">
          Browse popular releases, classics, and late-night movie picks.
        </p>
      </div>
